...
const getPendingApprovals = (t: (key: string) => string) => [
  { id: '1', title: 'Deploy Dashboard v1.2', requester: 'Codex', type: 'deployment', time: '2 hours ago', status: 'pending' },
  { id: '2', title: 'Publish Article: AI Tools Guide', requester: 'Quill', type: 'content', time: '5 hours ago', status: 'pending' },
  { id: '3', title: 'Schedule Tweet Storm', requester: 'Echo', type: 'social', time: '1 day ago', status: 'pending' },
]

export function ApprovalsView() {
  const { t } = useI18n()
  const pendingApprovals = getPendingApprovals(t)
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{t('approvals.requestedBy')} {approval.requester} • {approval.time}</p>
                    </div>
                  </div>
